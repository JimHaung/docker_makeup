...
class DMT(object):
    ...
    def interpolated(self, A, B, n=3):
        ...
        imsave(os.path.join('src/result','interpolated.png'), result)
    ...
    def hybrid(self, A, B1, B2, n=3):
        ...
        imsave(os.path.join('src/result','hybrid.png'), result)
    ...
    def multimodal(self, A, n=3):
        ...
        imsave(os.path.join('src/result','multimodal.png'), result)
